...
namespace Confluent.Kafka
{
    ...
    public static class Serializers
    {
        ...
        {
            public ReadOnlySpan<byte> Serialize(Null data, SerializationContext context)
                => null;
        }
        ...
        {
            public ReadOnlySpan<byte> Serialize(long data, SerializationContext context)
            {
        ...
        {
            public ReadOnlySpan<byte> Serialize(int data, SerializationContext context)
            {
        ...
        {
            public ReadOnlySpan<byte> Serialize(float data, SerializationContext context)
            {
        ...
        {
            public ReadOnlySpan<byte> Serialize(double data, SerializationContext context)
            {
                if (BitConverter.IsLittleEndian)
                {
                    unsafe
        ...
        {
            public ReadOnlySpan<byte> Serialize(byte[] data, SerializationContext context)
                => data;
        }
    }
}
